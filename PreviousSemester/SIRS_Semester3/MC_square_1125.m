...
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
function fig_surf(MTime)
%==========================================================================
% Изображение поверхнсти
%**************************************************************************
global Nx Ny N
global Latt Nei
%**************************************************************************
C = zeros(Ny, Nx, 'uint8');
Color0 = [1 1 1]; % x, susceptible белый
Color1 = [1 0 0]; % y, infected красный
Color2 = [0 0 1]; % z, recovered синий
%--------------------------------------------------------------------------
map(1,:) = Color0;
map(2,:) = Color1;
map(3,:) = Color2;
...
class_MC(68).list_number = 0;
% a = class_MC(68).rates
%--------------------------------------------------------------------------
class_MC(69)             = class_MC(68);
class_MC(69).number      = 11121;
%--------------------------------------------------------------------------
class_MC(70)             = class_MC(68);
class_MC(70).number      = 11211;
%--------------------------------------------------------------------------
class_MC(71)             = class_MC(68);
class_MC(71).number      = 12111;
%**************************************************************************
class_MC(72).number      = 22111;
...
class_MC(72).list_number = 0;
% a = class_MC(72).rates
%--------------------------------------------------------------------------
class_MC(73)             = class_MC(72);
class_MC(73).number      = 21121;
%--------------------------------------------------------------------------
class_MC(74)             = class_MC(72);
class_MC(74).number      = 11221;
%--------------------------------------------------------------------------
class_MC(75)             = class_MC(72);
class_MC(75).number      = 12211;
%--------------------------------------------------------------------------
...
for i = 1 : N  % перебор по узлам
    if (Latt(i) == 1)
        ...
        a = Latt(Nei(1,i))*10000 + ...
            ...
            Latt(Nei(4,i))*10 + 1;
        % ищем нужный класс
        for j = 1 : number_class_MC
            if (a == class_MC(j).number)
                class_MC(j).list_number = class_MC(j).list_number + 1; 
                class_MC(j).list(class_MC(j).list_number) = i;
                break
            end
        end
    end
    if (Latt(i) == 2)
        class_MC(82).list_number = class_MC(82).list_number + 1; 
        class_MC(82).list(class_MC(82).list_number) = i;
    end
end
%--------------------------------------------------------------------------
% % Проверка
% nn = 0;
% for i = 1 : number_class_MC
%     b = class_MC(i).list_number;
%     nn = nn + b; 
% end
% aa = N1ini+N2ini 
% nn
